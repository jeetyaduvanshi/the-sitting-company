...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-brand-deep border-t border-brand-gold/15 text-brand-grey pt-10 relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pb-10">
        {/* Col 1: Brand & Socials */}
        <div className="flex flex-col items-start gap-4">
          ...
          <p className="font-dmsans text-[14px] leading-relaxed text-brand-grey max-w-[240px]">
            Shaping spaces with luxury, high-end seating crafted for offices,
            homes, and events. Since 2020.
          </p>
          <div>
            <p className="font-dmsans text-[12px] uppercase tracking-widest text-brand-gold font-bold mb-2">
              FOLLOW US
            </p>
        ...
        <div className="flex flex-col gap-3">
          <h3 className="text-[13px] font-dmsans uppercase tracking-widest text-brand-gold font-bold mb-1">
            QUICK LINKS
          </h3>
          <div className="flex flex-col gap-2">
            {quickLinks.map((link) => (
              <Link
                key={link.name}
                href={link.href}
                className="font-dmsans text-[14px] hover:text-brand-cream transition-colors duration-300 w-fit"
              >
                {link.name}
              </Link>
            ))}
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-2.5">
            <Link
              ...
              className="flex items-center gap-2.5 font-dmsans text-[14px] hover:text-brand-cream transition-colors duration-300 w-fit"
            >
            ...
            <div className="flex items-start gap-2.5 font-dmsans text-[14px] text-brand-grey">
      ...
      <div className="bg-brand-black/80 border-t border-brand-gold/10 py-4 text-center">
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col sm:flex-row items-center justify-between gap-3">
          <span className="font-dmsans text-[13px] text-brand-grey/80">
            © {new Date().getFullYear()} The Sitting Company. All Rights Reserved.
          </span>
          <span className="font-dmsans text-[11px] text-brand-gold/60 uppercase tracking-widest">
